...
u2(0,-pi) qregless[17];
u2(0,-pi) qregless[18];
u3(0.92729522,0,0) qregless[19];
cx qregless[0],qregless[19];
u(-0.92729522,0,0) qregless[19];
cx qregless[0],qregless[19];
u3(0.92729522,0,0) qregless[19];
cx qregless[1],qregless[19];
u(-1.8545904,0,0) qregless[19];
cx qregless[1],qregless[19];
u3(1.8545904,0,0) qregless[19];
cx qregless[2],qregless[19];
u(-3.7091809,0,0) qregless[19];
cx qregless[2],qregless[19];
u3(2.5740044,-pi,-pi) qregless[19];
cx qregless[3],qregless[19];
u(-7.4183617,0,0) qregless[19];
cx qregless[3],qregless[19];
u3(1.1351764,0,0) qregless[19];
cx qregless[4],qregless[19];
u(-14.836723,0,0) qregless[19];
cx qregless[4],qregless[19];
u3(2.2703529,0,0) qregless[19];
cx qregless[5],qregless[19];
u(-29.673447,0,0) qregless[19];
cx qregless[5],qregless[19];
u3(1.7424796,-pi,-pi) qregless[19];
cx qregless[6],qregless[19];
u(-59.346894,0,0) qregless[19];
cx qregless[6],qregless[19];
u3(2.7982262,0,0) qregless[19];
cx qregless[7],qregless[19];
u(-118.69379,0,0) qregless[19];
cx qregless[7],qregless[19];
u3(0.68673293,-pi,-pi) qregless[19];
cx qregless[8],qregless[19];
u(-237.38758,0,0) qregless[19];
cx qregless[8],qregless[19];
u3(1.3734659,-pi,-pi) qregless[19];
cx qregless[9],qregless[19];
u(-474.77515,0,0) qregless[19];
cx qregless[9],qregless[19];
u3(2.7469317,-pi,-pi) qregless[19];
cx qregless[10],qregless[19];
u(-949.5503,0,0) qregless[19];
cx qregless[10],qregless[19];
u3(0.78932185,0,0) qregless[19];
cx qregless[11],qregless[19];
u(-1899.1006,0,0) qregless[19];
cx qregless[11],qregless[19];
u3(1.5786437,0,0) qregless[19];
cx qregless[12],qregless[19];
u(-3798.2012,0,0) qregless[19];
cx qregless[12],qregless[19];
u3(3.1258979,-pi,-pi) qregless[19];
cx qregless[13],qregless[19];
u(-7596.4024,0,0) qregless[19];
cx qregless[13],qregless[19];
u3(0.031389489,0,0) qregless[19];
cx qregless[14],qregless[19];
u(-15192.805,0,0) qregless[19];
cx qregless[14],qregless[19];
u3(0.062778978,0,0) qregless[19];
cx qregless[15],qregless[19];
u(-30385.61,0,0) qregless[19];
cx qregless[15],qregless[19];
u3(0.12555796,0,0) qregless[19];
cx qregless[16],qregless[19];
u(-60771.219,0,0) qregless[19];
cx qregless[16],qregless[19];
u3(0.25111591,0,0) qregless[19];
cx qregless[17],qregless[19];
u(-121542.44,0,0) qregless[19];
cx qregless[17],qregless[19];
u3(0.50223183,0,0) qregless[19];
cx qregless[18],qregless[19];
u(-243084.88,0,0) qregless[19];
cx qregless[18],qregless[19];
u(243084.88,0,0) qregless[19];
h qregless[18];
cp(-pi/2) qregless[17],qregless[18];
cp(-pi/4) qregless[16],qregless[18];
cp(-pi/8) qregless[15],qregless[18];
cp(-pi/16) qregless[14],qregless[18];
cp(-pi/32) qregless[13],qregless[18];
cp(-pi/64) qregless[12],qregless[18];
cp(-pi/128) qregless[11],qregless[18];
cp(-pi/256) qregless[10],qregless[18];
h qregless[17];
...
h qregless[12];
rxx(3*pi/2) qregless[11],qregless[12];
cp(-pi/4) qregless[10],qregless[12];
h qregless[11];
cp(-pi/2) qregless[10],qregless[11];
h qregless[10];
cp(-pi/512) qregless[9],qregless[18];
cp(-pi/1024) qregless[8],qregless[18];
cp(-pi/2048) qregless[7],qregless[18];
cp(-pi/4096) qregless[6],qregless[18];
cp(-pi/8192) qregless[5],qregless[18];
cp(-pi/16384) qregless[4],qregless[18];
cp(-pi/32768) qregless[3],qregless[18];
cp(-pi/65536) qregless[2],qregless[18];
cp(-pi/131072) qregless[1],qregless[18];
cp(-pi/262144) qregless[0],qregless[18];
...
h qregless[0];
barrier qregless[0],qregless[1],qregless[2],qregless[3],qregless[4],qregless[5],qregless[6],qregless[7],qregless[8],qregless[9],qregless[10],qregless[11],qregless[12],qregless[13],qregless[14],qregless[15],qregless[16],qregless[17],qregless[18],qregless[19];
