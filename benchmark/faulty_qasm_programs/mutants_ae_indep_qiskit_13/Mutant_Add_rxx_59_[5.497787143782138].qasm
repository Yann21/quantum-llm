...
u2(0,-pi) qregless[10];
u2(0,-pi) qregless[11];
u3(0.92729522,0,0) qregless[12];
cx qregless[0],qregless[12];
u(-0.92729522,0,0) qregless[12];
cx qregless[0],qregless[12];
u3(0.92729522,0,0) qregless[12];
cx qregless[1],qregless[12];
u(-1.8545904,0,0) qregless[12];
cx qregless[1],qregless[12];
u3(1.8545904,0,0) qregless[12];
cx qregless[2],qregless[12];
u(-3.7091809,0,0) qregless[12];
cx qregless[2],qregless[12];
u3(2.5740044,-pi,-pi) qregless[12];
cx qregless[3],qregless[12];
u(-7.4183617,0,0) qregless[12];
cx qregless[3],qregless[12];
u3(1.1351764,0,0) qregless[12];
cx qregless[4],qregless[12];
u(-14.836723,0,0) qregless[12];
cx qregless[4],qregless[12];
u3(2.2703529,0,0) qregless[12];
cx qregless[5],qregless[12];
u(-29.673447,0,0) qregless[12];
cx qregless[5],qregless[12];
u3(1.7424796,-pi,-pi) qregless[12];
cx qregless[6],qregless[12];
u(-59.346894,0,0) qregless[12];
cx qregless[6],qregless[12];
u3(2.7982262,0,0) qregless[12];
cx qregless[7],qregless[12];
u(-118.69379,0,0) qregless[12];
cx qregless[7],qregless[12];
u3(0.68673293,-pi,-pi) qregless[12];
cx qregless[8],qregless[12];
u(-237.38758,0,0) qregless[12];
cx qregless[8],qregless[12];
u3(1.3734659,-pi,-pi) qregless[12];
cx qregless[9],qregless[12];
u(-474.77515,0,0) qregless[12];
cx qregless[9],qregless[12];
u3(2.7469317,-pi,-pi) qregless[12];
cx qregless[10],qregless[12];
u(-949.5503,0,0) qregless[12];
cx qregless[10],qregless[12];
u3(0.78932185,0,0) qregless[12];
cx qregless[11],qregless[12];
u(-1899.1006,0,0) qregless[12];
