...
u2(0,-pi) qregless[8];
u2(0,-pi) qregless[9];
u3(0.92729522,0,0) qregless[10];
cx qregless[0],qregless[10];
u(-0.92729522,0,0) qregless[10];
cx qregless[0],qregless[10];
u3(0.92729522,0,0) qregless[10];
cx qregless[1],qregless[10];
u(-1.8545904,0,0) qregless[10];
rzz(7*pi/4) qregless[1],qregless[10];
cx qregless[1],qregless[10];
u3(1.8545904,0,0) qregless[10];
cx qregless[2],qregless[10];
u(-3.7091809,0,0) qregless[10];
cx qregless[2],qregless[10];
u3(2.5740044,-pi,-pi) qregless[10];
cx qregless[3],qregless[10];
u(-7.4183617,0,0) qregless[10];
cx qregless[3],qregless[10];
u3(1.1351764,0,0) qregless[10];
cx qregless[4],qregless[10];
u(-14.836723,0,0) qregless[10];
cx qregless[4],qregless[10];
u3(2.2703529,0,0) qregless[10];
cx qregless[5],qregless[10];
u(-29.673447,0,0) qregless[10];
cx qregless[5],qregless[10];
u3(1.7424796,-pi,-pi) qregless[10];
cx qregless[6],qregless[10];
u(-59.346894,0,0) qregless[10];
cx qregless[6],qregless[10];
u3(2.7982262,0,0) qregless[10];
cx qregless[7],qregless[10];
u(-118.69379,0,0) qregless[10];
cx qregless[7],qregless[10];
u3(0.68673293,-pi,-pi) qregless[10];
cx qregless[8],qregless[10];
u(-237.38758,0,0) qregless[10];
cx qregless[8],qregless[10];
u3(1.3734659,-pi,-pi) qregless[10];
cx qregless[9],qregless[10];
u(-474.77515,0,0) qregless[10];
cx qregless[9],qregless[10];
u(474.77515,0,0) qregless[10];
h qregless[9];
